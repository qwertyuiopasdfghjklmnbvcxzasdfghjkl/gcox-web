<template>
  <div class="cont">
    <p class="top">{{$t('account.add_release_title')}}
      <!-- Trading Amount Require For Additional 1% Bonus Release --></p>
    ...
    .bar {
      .bar-cont {
        ...
        span {
          ...
          top: 0;
          bottom: 0;
          background: -webkit-linear-gradient(left, #003659, #1e89cb);
          background: linear-gradient(left, #003659, #1e89cb);
        }
      }
    }
  }
