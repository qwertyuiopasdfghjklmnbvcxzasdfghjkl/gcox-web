        ...
        <div class="login-container">
            ...
            <div class="login-right">
                <div class="login-right-item item-register">
                    ...
                    <inputbox id="GCOX-password" type="password" name="password" v-model="formData.password" v-validate="'required|password'" :msgs="msgs.password" :errs="errors" :title="$t('exchange.exchange_password')" :placeholder="$t('login_register.password')"/><!--密码-->
                    ...
                    <div class="checkbox-group">
                        ...
                        <span>
                          ...
                          <a :href="getAgreementUrl" target="_blank">{{$t('login_register.bitark_service').format('GCOX')}}<!--GCOX服务条款--></a>
                        </span>
                    </div>
                    <div class="button-group">
                        <buttonbox :class="{disabled:locked||gtLocked}" :text="$t('login_register.register')" @click="register"/><!--注册-->
                        <div class="link">
                            <a href="javascript:;" @click="loginDialog" v-html="$t('login_register.Already_registered_Login').format(`<font color='#3A76E7'>GCOX</font>`)"><!--已有GCOX账号，请登录--></a>
                        </div>
                    </div>
                </div>
            </div>
