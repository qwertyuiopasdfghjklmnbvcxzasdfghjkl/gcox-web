      ...
      <div class="notice-dialog" v-show="isShowNotice">
        <div class="notice-dialog-container">
          ...
          <div class="notice-dialog-cont">
            ...
            <p><span>8.</span>{{$t('otc_ad.otc_trade_notice8')}}<!--更详细的交易规范请查看：--><a href="https://gcox.kf5.com/hc/kb/article/1225857/" target="_blank">{{$t('otc_ad.otc_trade_specification')}}<!--OTC交易规范--></a></p>
          </div>
        </div>
      </div>
      <ul class="list">
