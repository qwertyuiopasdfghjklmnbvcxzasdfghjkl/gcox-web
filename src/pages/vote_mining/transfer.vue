  ...
  methods: {
    ...
    submit () {
      if(!this.formData.amount){
        Tip({type: 'danger', message: this.$t('vote_mining.transfer_quantity_input')})
        return
      }
...
.icon-two-way { margin-left: 20px; margin-right: 20px;line-height: 0.8rem;}
.two-way-change {
  display: flex;
  justify-content: space-between;
  p {line-height: 0.8rem;}
}
.transfer-dialog{width: 100vw; background-color: #fff; color: #333;}
.transfer-dialog-title{height: 0.8rem;line-height: 0.8rem;color: #fff;font-size: 0.32rem;  text-align: center;background-color: #0D66EF;}
.transfer-dialog-form{padding: 0.3rem 0.3rem 1.2rem; position: relative; font-size: 0.26rem;}
.transfer-dialog-row {display: flex; justify-content: space-between; padding-bottom: 0.3rem; line-height: 0.6rem;}
.transfer-dialog-label{color: #333; margin-right: 0.15rem;}
.transfer-dialog-select{
  flex:1; height: 0.6rem;color:#333;background-color: transparent;border: 1px solid #ccc; border-radius: 4px; font-size: 0.26rem; box-sizing: border-box; background: url('../../assets/img/cdcc/arrow-down-blue.png') no-repeat 98% center; background-size: auto 0.3rem; padding-left: 0.15rem; line-height: 0.6rem;
}
.transfer-dialog-input{
  flex:1; height: 0.6rem;color:#333;background-color: transparent;border: 1px solid #ccc; border-radius: 4px; font-size: 0.26rem; box-sizing: border-box;  padding-left: 0.15rem; line-height: 0.6rem;
}
...
.transfer-dialog-btns button {flex: 1; height: 50px; font-size: 0.28rem; border: none;}
</style>
