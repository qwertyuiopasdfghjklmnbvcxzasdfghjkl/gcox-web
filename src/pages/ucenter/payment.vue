<template>
  <div class="page">
    ...
    <div class="box">
      <div class="inner">
        <h1>{{$t('otc_legal.otc_legal_Alipay_receivables')}}<!--支付宝收款--></h1>
        <form ref="alipayForm">
        ...
        <footer>
          <p></p>
          <button class="c-button c-button-normal c-button-blue" @click="saveSettings(2)">{{$t('otc_legal.otc_legal_save')}}<!--保存--></button>
        </footer>
      </div>
    </div>
  </div>
