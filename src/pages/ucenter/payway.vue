<template>
  <div class="page">
    ...
    <div class="page-main">
      <h1>{{$t('otc_legal.otc_legal_currency')}}<!--收款方式设置--></h1>
      <div class="item-inner">
        <!--1-1已设置银行卡-->
        <section v-if="bankData.card_number" class="item" v-tap="{methods: checkVerifyState, to: 'page-bankset'}">
          <div class="inner">
        ...
        <!--2-1已设置微信-->
        <section v-if="wechatData.wechat_number" class="item" v-tap="{methods:checkVerifyState, to:'page-WeChat'}">
          <div class="inner">
        ...
        <!--3-1已设置支付宝-->
        <section v-if="alipayData.alipay_number" class="item" v-tap="{methods:checkVerifyState, to:'page-payment'}">
          <div class="inner">
        ...
        <!--4-1已设置PayPal-->
        <section v-if="paypalData.paypal_number" class="item" v-tap="{methods:checkVerifyState, to:'page-paypal'}">
          <div class="inner">
    ...
    >.inner{
      ...
      h3{
        ...
        span{
          ...
          height: .28rem;
          margin-top: .06rem;
          background: url('../../assets/img/n_i_icon.png') no-repeat center center / 100% auto;
        }
      }
    }
  }
