...
import adconfirm from '@/pages/otc/adconfirm'
...
<style scoped>
.createorder{height: 100vh; overflow-y: auto; background-color: #161f2f;}
.createorder .title{height: 0.6rem;line-height: 0.6rem;text-align: center;color: #becbe8;background-color: #0c151d; font-size: 0.24rem;}
...
.cont-item label em.asterisk{position: relative;top: 6px;line-height: 0;font-size: 18px;color: #0072fd;}
...
.cont-item.tradetype .value span i{padding-right: 4px;color: #0072fd;}
.cont-item.tradetype .value span i:hover{color: #0072fd;}
...
.cont-item.button{line-height: 0;font-size: 0; display: flex; justify-content: space-between;}
.cont-item.button button{width: 48%; height: 0.75rem;font-size: 0.32rem;border-radius: 4px; border: 1px solid #0072fd;}
.cont-item.button button.cancel{color: #0072fd;background-color: transparent;}
.cont-item.button button.cancel:hover{color: #0072fd;border-color: #0072fd;}
.cont-item.button button.comfirm{color: #fff;background-color: #0072fd;}
.cont-item.button button.comfirm:hover{background-color: #0072fd;}
