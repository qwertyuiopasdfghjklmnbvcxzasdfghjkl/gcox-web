...
<style scoped>
.title{height: 34px;font-weight: bold;font-size: 16px;line-height: 34px;color: #0072fd;border-bottom: 1px solid #333232;}
.ad-row{display: flex; justify-content: space-between;}
.ad-row span{min-height: 30px;line-height: 30px;}
.ad-row span:first-of-type{color: #8a93a8;}
