    ...
    <section class="place_order">
        ...
        <section class="form">
            ...
            <section class="form-buttons">
                <button class="cancel" @click="cancel">{{$t('otc_legal.otc_legal_cancel')}}<!--取消--></button>
                <button class="sure" :class="{disabled:locked}" @click="createOrder">{{$t('otc_ad.otc_ad_confirm')}}<!--确认--></button>
            </section>
        </section>
    </section>
</template>
...
@white_color:#fff;
@blue_color:#0072fd;
.place_order{width:100%;height:7.34rem;display:flex;flex-direction:column;background-color:#161f2f;}
.header{display:flex;height:1rem;background:#0c151d;align-items:center;justify-content:space-between;}
...
.form-row-input input{border-radius: 0.05rem;display:flex;flex:1;height:1rem;background-color:transparent;border:0.01rem solid #8089a3;color:#fff;padding:0 0.34rem;font-size:0.28rem;}
.form-row-input input:focus{border-color:@blue_color;}
.form-row-input em{display:block;font-style:normal;font-size:0.3rem;color:#CBD4EC;position:absolute;right:0.32rem;top:0.3rem;line-height:0.44rem;}
.form-buttons{display:flex;justify-content:space-between;}
.form-buttons button{border:0.02rem solid @blue_color;height:0.96rem;background:transparent;border-radius:0.04rem;}
.form-buttons button.cancel{width:2.24rem;color:@blue_color;font-size:0.3rem;}
.form-buttons button.sure{width:4.46rem;background:@blue_color;color:@white_color;font-size:0.36rem;}
.form-buttons button.sure.disabled{background:#8089A3;border-color:#8089A3;cursor:not-allowed;}
</style>
